...
## Project Structure
    ...
    ├── tv_show_suggestor_37902  # Django project configurations
...
1. Clone this repo and `cd tv_show_suggestor_37902`
...
2. Clone this repo and `cd tv_show_suggestor_37902`
